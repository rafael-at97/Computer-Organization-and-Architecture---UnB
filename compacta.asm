...
Abre_Arquivos: # Abre os arquivos textos que seram necessários no programa
	
	li $v0, 13		# Código  do open file
	la $a0, dicionario	# Label do arquivo a ser lido
	li $a1, 9		# flag 9
...
Concatena: # Concatena o caractere lido do arquivo texto no buffer de comparação
	...
	############### aqui deve ser um brench diferente. Coloquei esse pois era um jeito fácil para ver se o resto estava funcionando
